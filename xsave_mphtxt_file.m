...
for i = 1:size(ximage,1)            
    for j = 1:size(ximage,2)
        for k = 1:size(ximage,3)
            if(ximage(i,j,k) == 0)               % Pore -- Default (I)
                ximage(i,j,k) = 55;
            elseif(ximage(i,j,k) == 171)         % Ionomer -- Verify the pixel value (II)
                ximage(i,j,k) = 100;
            elseif(ximage(i,j,k) == 85)          % Catalyst -- Verify the pixel value (III)
                ximage(i,j,k) = 150;
            elseif(ximage(i,j,k) == 4)           % Current collector (V)
                ximage(i,j,k) = 250;           
            elseif(ximage(i,j,k) == 3)           % Membrane (IV)
                ximage(i,j,k) = 200;           
            end
        end
    end
...
% Face group
% Face 12 : Pore/Catalyst ??
% Face 13 : Pore/Ionomer 
% Face 14 : Pore/Membrane
% Face 15 : Pore/CC
% Face 24 : Catalyst/Membrane
% Face 34 : Ionomer/Membrane
% Face 25 : Catalyst/CC
% Face 35 : Ionomer/CC
global in12 in23 in13 in14 in15 in24 in34 in25 in35 
global inter12 inter23 inter13 inter14 inter15 inter24 inter34 inter25 inter35 
global xf_mm xf_CC
n_faces = size(face,1);
...
in12 = 1;       % Pore/Ionomer || counter
in23 = 1;       % Ionomer/Catalyst
in13 = 1;       % Pore/Catalyst
in14 = 1;       % Pore/Mem
in15 = 1;       % Pore/CC
in24 = 1;       % Catalyst/Membrane
in34 = 1;       % Ionomer/Membrane
in25 = 1;       % Catalyst/CC
in35 = 1;       % Ionomer/CC
in11 = 1;
in22 = 1;
...
in44 = 1;
in55 = 1;
clear inter12 inter23 inter13 inter14 inter15 inter24 inter34 inter25 inter35 
clear inter11 inter22 inter33 inter44 inter55
global inter12 inter23 inter13 inter14 inter15 inter24 inter34 inter25 inter35 
% for nf1 = 1:n_faces_2
%     nf2  = nf1*2;
...
for nf1 = 1:2:n_faces
    ...
    if (face(nf1,4) == face(nf2,4))
        ...
        elseif(face(nf1,4)==2)              % Catalyst
            ...
            in22 = in22 + 1;
        elseif(face(nf1,4)==3)              % Ionomer
            faceID(nf3) = n_faces_2*4 + nf3;
            inter33(in33,1) = faceID(nf3);
            in33 = in33 + 1;
        elseif(face(nf1,4)==4)              % Membrane
            faceID(nf3) = n_faces_2*5 + nf3;
            inter44(in44,1) = faceID(nf3);
            in44 = in44 + 1;
        elseif(face(nf1,4)==5)              % Current collector
            faceID(nf3) = n_faces_2*6 + nf3;
            inter55(in55,1) = faceID(nf3);
            in55 = in55 + 1;
        end
    else
        faceID(nf3) = nf3;
        xt = 10*face(nf1,4) + face(nf2,4);
        if(xt == 12 || xt == 21)           % Pore/Catalyst
            inter12(in12,1) = faceID(nf3); 
            in12 = in12 + 1;    
        elseif(xt == 23 || xt == 32)       % Ionomer/Catalyst
            inter23(in23,1) = faceID(nf3); 
            in23 = in23 + 1;
        elseif(xt == 13 || xt == 31)       % Pore/Ionomer
        ...
        elseif(xt == 14 || xt == 41)       % Pore/Membrane
            ...
            in14 = in14 + 1;
        elseif(xt == 15 || xt == 51)       % Pore/CC
            inter15(in15,1) = faceID(nf3); 
            in15 = in15 + 1;
        elseif(xt == 24 || xt == 42)       % Catalyst/Membrane
            inter24(in24,1) = faceID(nf3); 
            in24 = in24 + 1;
        elseif(xt == 34 || xt == 43)       % Ionomer/Membrane
            inter34(in34,1) = faceID(nf3); 
            in34 = in34 + 1;
        elseif(xt == 25 || xt == 52)       % Catalyst/Current collector
            inter25(in25,1) = faceID(nf3); 
            in25 = in25 + 1;
        elseif(xt == 35 || xt == 53)       % Ionomer/Current collector
            inter35(in35,1) = faceID(nf3); 
            in35 = in35 + 1;
        end
    end
    nf3 = nf3 + 1;
...
global inter12 inter23 inter13 inter14 inter15 
global inter24 inter34 inter25 inter35 xf_mm xf_CC
...
xfilename = strcat('PEM-',date,'.mphtxt');
...
fprintf(fid,'12 meshselcdom5        #tag 6\n'); % Current collector - domain
fprintf(fid,'12 meshselcfac1        #tag 7\n'); 
fprintf(fid,'12 meshselcfac2        #tag 8\n'); 
fprintf(fid,'12 meshselcfac3        #tag 9\n'); 
fprintf(fid,'12 meshselcfac4        #tag 10\n');
fprintf(fid,'12 meshselcfac5        #tag 11\n'); 
fprintf(fid,'12 meshselcfac6        #tag 12\n'); 
fprintf(fid,'12 meshselcfac7        #tag 13\n'); 
fprintf(fid,'12 meshselcfac8        #tag 14\n'); 
fprintf(fid,'12 meshselcfac9        #tag 15\n'); 
fprintf(fid,'13 meshselcfac10       #tag 16\n');
fprintf(fid,'13 meshselface11       #tag 17\n');
%fprintf(fid,'9 edgeselc1            #tag 8\n');% 3PB          
fprintf(fid,'17                      #number of objects\n'); % Equal number of tags
...
fprintf(fid,'5 obj12                #object 12\n');
fprintf(fid,'5 obj13                #object 13\n');
fprintf(fid,'5 obj14                #object 14\n');
fprintf(fid,'5 obj15                #object 15\n');
fprintf(fid,'5 obj16                #object 16\n');
fprintf(fid,'5 obj17                #object 17\n');
...
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
fprintf(fid,'12 Pore/Ionomer    #Label\n');
fprintf(fid,'5 mesh1            #Mesh tag\n');
...
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
fprintf(fid,'13 Pore/Catalyst   #Label\n');
fprintf(fid,'5 mesh1            #Mesh tag\n');
fprintf(fid,'2                  #Dimension\n');
fprintf(fid,'%d                 #number of entities\n',numel(inter13));
fprintf(fid,'#Entity tags\n');
...
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
fprintf(fid,'13 Pore/Membrane   #Label\n');
fprintf(fid,'5 mesh1            #Mesh tag\n');
fprintf(fid,'2                  #Dimension\n');
fprintf(fid,'%d                 #number of entities\n',numel(inter14));
fprintf(fid,'#Entity tags\n');
...
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
fprintf(fid,'7 Pore/CC   #Label\n');
fprintf(fid,'5 mesh1            #Mesh tag\n');
fprintf(fid,'2                  #Dimension\n');
fprintf(fid,'%d                 #number of entities\n',numel(inter15));
fprintf(fid,'#Entity tags\n');
for iq = 1:numel(inter15)
    fprintf(fid,'%d\n',inter15(iq));
end
fprintf(fid,'\n\n');
...
fprintf(fid,'%d                 #number of entities\n',numel(inter34));
fprintf(fid,'#Entity tags\n');
for iq = 1:numel(inter34)
    fprintf(fid,'%d\n',inter34(iq));
end
fprintf(fid,'\n\n');
fprintf(fid,'# ---------------- Object 13 -----------------\n');
fprintf(fid,'0 0 1              #Default version\n');
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
fprintf(fid,'11 Catalyst/CC   #Label\n');
fprintf(fid,'5 mesh1            #Mesh tag\n');
fprintf(fid,'2                  #Dimension\n');
fprintf(fid,'%d                 #number of entities\n',numel(inter25));
fprintf(fid,'#Entity tags\n');
for iq = 1:numel(inter25)
    fprintf(fid,'%d\n',inter25(iq));
end
fprintf(fid,'\n\n');
fprintf(fid,'# ---------------- Object 14 -----------------\n');
fprintf(fid,'0 0 1              #Default version\n');
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
fprintf(fid,'10 Ionomer/CC      #Label\n');
fprintf(fid,'5 mesh1            #Mesh tag\n');
fprintf(fid,'2                  #Dimension\n');
fprintf(fid,'%d                 #number of entities\n',numel(inter35));
fprintf(fid,'#Entity tags\n');
for iq = 1:numel(inter35)
    fprintf(fid,'%d\n',inter35(iq));
end
fprintf(fid,'\n\n');
fprintf(fid,'# ---------------- Object 15 -----------------\n');
fprintf(fid,'0 0 1              #Default version\n');
fprintf(fid,'9 Selection        #Class\n');
fprintf(fid,'0                  #Version\n');
