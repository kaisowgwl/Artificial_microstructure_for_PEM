classdef Microstructure_generation_additives_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function Bridge_generationButtonPushed(app, event)
         ...
         %   function [app.Microstructure] = generate_additiveapp.Mic(rostructure,background_id,additive_id,target_volume_fraction,minimum_dist,randomize_level,erosiondilatation_depth)
